...
export function DeleteMaterialButton({ id, name }: { id: string; name: string }) {
  ...
  return (
    <button
      ...
      onClick={onDelete}
      disabled={loading}
      className="inline-flex shrink-0 items-center gap-1.5 rounded-lg border border-red-200 bg-white px-3 py-2 text-sm font-medium text-red-600 hover:bg-red-50 disabled:opacity-60"
    >
